...
<div id="myTabContent" class="tab-content">
	<div class="tab-pane fade active show" id="harian"><br />
		<form action="<?=base_url('p/laporan_harian');?>" method="POST">
			<div class="form-group">
				<input name="tanggal" id="datepicker" placeholder="Tanggal" required=""><script>$('#datepicker').datepicker({format: 'yyyy/mm/dd', showOtherMonths:true});</script>
			</div>
	...
	<div class="tab-pane fade" id="periode"><br />
		<form action="<?=base_url('p/laporan_periode');?>" method="POST">
    		<div class="form-group">
        		<input name="tgl_mulai" id="startDate" placeholder="Mulai tanggal"  required="">
        		<input name="tgl_sampai" id="endDate" placeholder="Sampai tanggal"  required="">
    		</div>
    		<script>
